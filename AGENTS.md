...
Guidance for Codex (and other AI coding agents) working in this repo.
...
- Before committing a behavior or pattern change, update the affected docs in the same commit (AGENTS.md, README.md).
- Keep commits small and single-line. No Codex attribution in commit messages.
